...
class Client
{
    ...
    /**
     * Returns the collection of options in an option set.
     *
     * @param array $filter
     * @return array
     */
    public static function getOptionSetOptions($id)
    {
        return self::getCollection('/optionsets/' . $id . '/options', 'OptionSet');
    }
     ...
     * @return mixed
     */
    public static function getProductOption($productId, $id)
    {
        return self::getResource('/products/' . $productId. '/options/'. $id,'Product');
    }
    ...
    {
        return self::getCollection('/products/' . $id. '/options/','Product');
    }
